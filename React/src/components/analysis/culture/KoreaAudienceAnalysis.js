...
import KoreaAudienceTable from '../table/culture/KoreaAudienceTable';
import AnalysisImg from '../img/culture/movie/korea_audience.png';

export default function KoreaAudienceAnalysis() {
